...
- [ ] `.github/PULL_REQUEST_TEMPLATE.md` に `<!-- /changelog -->` 終端マーカーを追加
  - 「ユーザー向け更新内容」セクション末尾、`---` の直前に挿入

## フェーズ2: update-changelog.mjs スクリプト作成

- [ ] `.github/scripts/update-changelog.mjs` を新規作成
...
- [ ] `.github/workflows/changelog-suggest.yml` を新規作成
  ```
...
- [ ] `.github/workflows/changelog-update.yml` を新規作成
  ```
...
- [ ] テスト用PRを作成し、AIドラフト提案が正しく投稿されることを確認
