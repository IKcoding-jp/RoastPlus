...
**自動確認の場合**: スクリーンショットをユーザーに提示する。（要件の承認はPhase 7で行う。Phase 6では承認を求めない）
...
⬜ [未確認の要件]（Phase 6のスクリーンショットで確認をお願いします）
```

3. **動作確認の結果**（Phase 6のスクリーンショット等）を補足
