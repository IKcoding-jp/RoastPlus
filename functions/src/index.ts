...
ローストスケジュール（RoastSchedule）:
- 予熱オン: isRoasterOn: true, time: "HH:mm"
- ロースト: isRoast: true, time: "HH:mm", roastCount: 数値（何回目か）
- アフターパージ: isAfterPurge: true, time: "HH:mm"（時間がない場合は空文字列）
- チャフのお掃除: isChaffCleaning: true, time: "HH:mm"
