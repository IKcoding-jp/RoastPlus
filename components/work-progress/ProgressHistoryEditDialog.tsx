    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm p-0 sm:p-4 transition-opacity duration-300">
      ...
      >
        ...
        <div className="px-4 py-3 border-b border-edge flex items-center justify-between bg-ground">
          <h3 className="font-bold text-ink truncate pr-4">履歴を編集</h3>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                autoFocus
              />
              <span className="text-xl font-medium text-ink-sub">{isCountMode ? '個' : unit || '個'}</span>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            <Button
              ...
              className={`flex-1 !rounded-xl shadow-md active:scale-[0.98] ${
                showDeleteConfirm ? '' : 'bg-danger/80 hover:bg-danger'
              }`}
            >
