    ...
    <>
      <div className="grid gap-3 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {sortedRecipes.map((recipe) => {
          ...
          return (
            <Card key={recipe.id} variant="hoverable" className="p-4 sm:p-5 flex flex-col">
              ...
              <div className="space-y-2 text-sm text-ink-sub mb-4 flex-grow">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    {Math.floor(calculatedRecipe.totalDurationSec / 60)}分{calculatedRecipe.totalDurationSec % 60}秒
                  </span>
                </div>
                {recipe.purpose && (
              ...
              <div className="mb-4">
                <Select
                  ...
                  options={[1, 2, 3, 4, 5, 6, 7, 8].map((serving) => ({
