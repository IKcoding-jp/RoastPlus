            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-3">
              ...
              <div className="sm:col-span-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateStep(index, 'targetTotalWater', e.target.value ? parseInt(e.target.value) : undefined)
                  }
                  placeholder="任意"
                  className="w-full p-3 sm:p-2 border border-edge rounded bg-field text-ink placeholder:text-ink-muted focus:ring-2 focus:ring-spot outline-none text-base"
                />
              ...
              <div
                className={
                  isManualMode ? 'sm:col-span-4 flex items-end justify-end' : 'sm:col-span-3 flex items-end justify-end'
                }
              >
                <IconButton
                  variant="ghost"
