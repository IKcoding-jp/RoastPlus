      ...
      {isToday && !isWeekend && (
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          ...
          <button
            ...
            className="px-6 py-3 sm:px-8 sm:py-4 text-white text-base sm:text-lg rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
            style={{ backgroundColor: '#EF8A00' }}
            onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#D87A00'}
            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#EF8A00'}
