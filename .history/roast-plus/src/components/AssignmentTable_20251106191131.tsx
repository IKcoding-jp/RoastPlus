    ...
    <div className="bg-white rounded-lg shadow p-4 sm:p-6">
      <div className="mb-4">
        <div className="overflow-x-auto">
          <table className="w-full border-collapse table-auto">
            <thead>
              <tr>
                <th className="border border-gray-300 p-2 sm:p-3 bg-gray-50 text-right text-gray-800 text-sm sm:text-base w-32 sm:w-40 whitespace-nowrap">
                  作業ラベル
                </th>
                {teams.map((team) => (
                  <th
                ...
                <th className="border border-gray-300 p-2 sm:p-3 bg-gray-50 text-left text-gray-800 text-sm sm:text-base w-32 sm:w-40 whitespace-nowrap">
                  作業ラベル
                </th>
              </tr>
            </thead>
              ...
              {displayLabels.map((taskLabel) => (
                <tr key={taskLabel.id}>
                  <td className="border border-gray-300 p-2 sm:p-3 bg-gray-50 w-32 sm:w-40">
                    <div className="font-medium text-gray-800 text-sm sm:text-base whitespace-nowrap text-right">{taskLabel.leftLabel}</div>
                  </td>
                  {teams.map((team) => {
                    const key = `${team.id}-${taskLabel.id}`;
                    ...
                    if (isShufflingAnimation) {
                      ...
                      memberName = getMemberName(assignment?.memberId || null);
                      isEmpty = !memberName;
                    }
                  ...
                  <td className="border border-gray-300 p-2 sm:p-3 bg-gray-50 w-32 sm:w-40">
                    {taskLabel.rightLabel && (
                      <div className="font-medium text-gray-600 text-sm sm:text-base whitespace-nowrap">
                        {taskLabel.rightLabel}
                      </div>
                    )}
                  </td>
      ...
      <div className="mt-6 flex justify-center">
        <button
          ...
          disabled={isShuffling || isShufflingAnimation}
        ...
        >
          {isShuffling || isShufflingAnimation ? '割り当て中...' : '今日の担当を決める'}
        </button>
      </div>
    </div>
  );
