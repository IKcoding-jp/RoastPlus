...
export default function TeamMemberManagement({
  ...
  // 除外設定セクションの展開状態を管理（メンバーIDをキーとする）
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                      {taskLabels.map((label) => {
                                        ...
                                        return (
                                          <label
                                            key={label.id}
                                            className="flex items-center gap-2 px-3 py-2 text-xs sm:text-sm bg-white border border-gray-300 rounded cursor-pointer hover:bg-gray-50 hover:border-amber-400 transition-colors"
                                          >
                                            <input
                                              type="checkbox"
                                              checked={isExcluded}
