...
// H4: デュアルカラーアクセント
// - Dropアイコン背景をブラウンに
// - カウントダウンの左アクセントラインをブラウンに
// - カウントダウンの秒数テキストはオレンジのまま
// - アクセントバーをブラウン→オレンジのグラデーションに
// - プログレスバーのトラック色をブラウン系に
export default function TimerPatternH4() {
      ...
      <div className="h-[667px] rounded-3xl border border-edge overflow-hidden flex flex-col bg-ground">
        ...
        <div className="flex-1 flex flex-col items-center px-5 pb-3 overflow-y-auto">
          ...
          <div className="w-full rounded-2xl overflow-hidden bg-surface border border-edge shadow-card">
            ...
            <div className="h-[3px] w-full bg-gradient-to-r from-dark via-spot to-spot/15" />
            ...
            {nextStep && (
              <div className="border-t border-edge-subtle">
                <div className="flex items-center gap-3 px-4 py-3">
                  {/* 左アクセントライン: ブラウン */}
                  <div className="w-[3px] self-stretch rounded-full bg-dark/30 flex-shrink-0" />
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {/* カウントダウンバー: トラック色をブラウン系に */}
                    <div className="w-full h-1 rounded-full bg-dark/10 overflow-hidden">
                      <div
                        className="h-full rounded-full bg-spot/50 transition-all duration-1000"
