...
// H5: コーヒーフッター
// - フッター（コントロール領域）をダークブラウン背景に
// - ボタンアイコン色を白系に
// - 再生ボタンをオレンジのまま（ブラウン背景で映える）
// - アクセントバーをブラウン→オレンジのグラデーションに
// - Dropアイコン背景をブラウンに
export default function TimerPatternH5() {
      ...
      <div className="h-[667px] rounded-3xl border border-edge overflow-hidden flex flex-col bg-ground">
        ...
        <div className="flex-1 flex flex-col items-center px-5 pb-3 overflow-y-auto">
          ...
          <div className="w-full rounded-2xl overflow-hidden bg-surface border border-edge shadow-card">
            ...
            <div className="h-[3px] w-full bg-gradient-to-r from-dark to-spot" />
        ...
        {/* コントロール: ダークブラウン背景 */}
        <div className="flex-none flex items-center justify-center gap-10 px-5 py-4 border-t border-edge bg-dark">
          {/* ボタンアイコン: 白系 */}
