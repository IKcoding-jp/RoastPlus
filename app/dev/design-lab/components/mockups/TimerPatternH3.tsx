...
// - Dropアイコン背景をブラウンに
// - アクセントバーはオレンジのまま
export default function TimerPatternH3() {
  ...
  return (
    <div className="max-w-sm mx-auto">
      <div className="h-[667px] rounded-3xl border border-edge overflow-hidden flex flex-col bg-ground">
        {/* ヘッダー: ダークブラウン背景 */}
        <div className="flex-none flex items-center justify-between px-5 pt-4 pb-1 bg-dark">
          <button className="p-1.5 rounded-full text-white/70 hover:text-white transition-colors">
            <ArrowLeft size={18} weight="bold" />
          </button>
          <span className="text-[10px] font-bold text-white/70 tracking-[0.15em] uppercase">
