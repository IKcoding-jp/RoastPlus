          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="px-4 py-3 flex items-center justify-between bg-ground border-b border-edge">
                ...
                <IconButton variant="ghost" size="sm" onClick={() => setContextMenu(null)}>
                  <MdClose size={20} />
                </IconButton>
              </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="px-4 py-3 flex items-center justify-between bg-ground border-b border-edge">
                ...
                <IconButton variant="ghost" size="sm" onClick={() => setShowMemberMenu(null)} aria-label="閉じる">
                  <MdClose size={20} />
                </IconButton>
              </div>
                      ...
                      <div key={m.id} className="flex items-center gap-2">
                        <Button
                          ...
                          onClick={() => {
                            onUpdateMember(
                              {
                                teamId: showMemberMenu.teamId,
                                taskLabelId: showMemberMenu.taskLabelId,
                                memberId: null,
                                assignedDate: '',
                              },
                              m.id
        ...
        {activeTeamActionId && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="mb-6">
                <Input label="班名" value={activeTeamName} onChange={(e) => setActiveTeamName(e.target.value)} />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="primary" size="sm" onClick={handleUpdateTeamFromModal} className="flex-1">
                    更新
                  </Button>
                </div>
              </div>
              ...
              {(widthConfig.type === 'taskLabel' || widthConfig.type === 'note') && (
                <div className="mb-4">
                  <Input
                    ...
                    onKeyDown={(e) =>
                      e.key === 'Enter' && handleSaveWidth(widthConfig.currentWidth, widthConfig.currentTitle)
                    }
                  />
                </div>
              )}
            ...
            >
              ...
              <div className="mb-4">
                <Input
                  ...
                  placeholder={
                    heightConfig.editMode === 'left'
                      ? `${headerLabels.left}を入力`
                      : `${headerLabels.right}を入力（任意）`
                  }
                />
              ...
              <div className="mb-6">
                <NumberInput
                  ...
                  onKeyDown={(e) =>
                    e.key === 'Enter' && handleSaveRowConfig(heightConfig.currentHeight, heightConfig.currentName)
                  }
                />
              </div>
